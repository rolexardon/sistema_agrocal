...
urlpatterns = patterns('empleados.views',
    ...
    url(r"^talonario", "gestion_talonarios", name="gestion_talonarios"),
    url(r"^crear1$", "empleado_crear", name="empleado_crear"),
    url(r"^crear$", "talonario_crear", name="talonario_crear"),
